    ...
    return (
        <section className='pt-[176px] pb-[112px]' id="about">
            ...
            <div className="flex flex-wrap items-center justify-center md:w-[60%] w-[95%] mx-auto font-thin md:gap-5 gap-3 mt-12">
                {
                    skills.map((skill, i) => <article key={i} className="hover:scale-95 transition-all duration-300  w-fit max-[320px]:w-full text-center py-2 px-5 md:text-4xl text-2xl uppercase  backdrop-blur-[2.4px] border-[0.5px] border-white/30 rounded-full cursor-pointer select-none bg-custom hover:rotate-3 shadow-md shadow-white/10">
                        {skill}
                    </article>)
                }
            </div>
